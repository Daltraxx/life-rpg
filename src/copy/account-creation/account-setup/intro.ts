  ...
  explainers: [
      ...
      points: [
        ...
        },
        {
          ...
          nestedPoints: [
            ...
            "For each attribute, if a task is especially significant in honing that attribute, up to two plus (+) symbols can be added to it. These will increase the points that attribute gains when completing that task. Be honest when making these evaluations!",
          ],
        },
        {
    ...
    },
    {
      ...
      points: [
        ...
        {
          text: "There are more details regarding leveling and daily point bonuses (like streaks and quest strength) that would make this introduction even longer. Once you've completed the setup, you can explore the Manual to understand how everything works.",
        },
      ],
    },
  ],
