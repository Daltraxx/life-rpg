 ...
 * 
 * @remarks
 * This function must be called in a server-side context (Server Components, Route Handlers, 
 * Server Actions) where Next.js cookies() is available. Cookie errors are logged to the 
