 ...
 * 
 * @remarks
 * This function must be called in server actions or route handlers where Next.js cookies() is available. 
 * Cookie errors are logged to the console before being re-thrown.
 */
