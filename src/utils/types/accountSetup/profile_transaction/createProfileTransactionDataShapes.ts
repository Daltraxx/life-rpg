 ...
 * @property {CreateProfileTransactionAttributes[]} p_attributes - An array of attribute objects representing the attributes to be created for the profile.
 * @property {CreateProfileTransactionQuests[]} p_quests - An array of quest objects representing the quests to be created for the profile.
 * @property {CreateProfileTransactionQuestsAttributes[]} p_quests_attributes - An array of quest-attribute relationship objects representing the relationships between quests and attributes for the profile.
 */
